    ...
    <div class="row">
                    ...
                    <div class="form-group mb-0">
                       ...
                       <div class="form-group">
                           ...
                           <textarea class="form-control form-control-lg @error('description')
                               is-invalid
                           @enderror" rows="13" form="createArticle" name="description" required>{{ old('description') }}</textarea>
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                       </div>
        ...
        <div class="col-12 col-lg-3">
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-0">
                       <button class="btn btn-primary btn-block" form="createArticle">Create Article</button>
                    </div>
                </div>
            </div>
        </div>
