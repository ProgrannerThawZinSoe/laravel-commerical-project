...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
               <div class="card-body">
                    ...
                    <form action="/dashboard/blog-category/{{ $blog->id }}/upgrade" class="mb-4" method="POST">
                        @csrf
    ...
    @foreach (App\BlogCategory::with('user')->get() as   $k=>$blogCategory)
            <tr>
                ...
                <td>
                    <a href="/dashboard/blog-category/{{  $blogCategory->id }}/edit" class="btn btn-sm btn-outline-success">Edit</a>
                    

                    <form action="/dashboard/blog-category/{{  $blogCategory->id }}/delete" method="post" class="d-inline-block" >
                        @csrf
                    
                        <input type="hidden" name="id" value="({{  $blogCategory->id }}">
                        <button type="submit" onclick="return confirm('Sure !')" class="btn btn-sm btn-outline-danger">Delete</button>
                    </form>
                </td>
                <td>
                    <span class="small">
