                    ...
                    <div class="form-group">
                       <div class="form-group mb-3">
                           ...
                           <input  type="text" class="form-control form-control-lg @error('title')
                               is-invalid
                           @enderror" form="createArticle" value="{{ $blog->title }}"  name="title" >
                            @error('title')
                       ...
                       <div class="form-group mb-3">
                        ...
                        @enderror" form="createArticle" name="category" >
                            ...
                            @foreach ($blogcategory as $category)
                                <option value="{{ $category->title }}" {{ $blog->categories == $category->title ? 'selected' : '' }}>{{ $category->title }}</option>
                            @endforeach
                        </Select>
                        @error('category')
                            <small class="text-danger">{{ $message }}</small>
                       ...
                       <div class="form-group">
                           ...
                           <textarea  class="form-control fs-5 @error('description')
                               is-invalid
                           @enderror" rows="15" form="createArticle" name="description"  > {{ $blog->description }} </textarea>
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                       </div>
                       ...
                       <div class="form-group mb-3">
                           ...
                           <input  type="text" class="form-control form-control-lg @error('title')
                               is-invalid
                           @enderror" form="createArticle" value="{{ $blog->read_time }}"  name="read" >
                            @error('title')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                       </div>
                       ...
                       <div class="form-group mt-4">
                            <button class="btn btn-warning w-100" form="createArticle">Update Blog</button>
                        </div>
                    </div>
                </div>
            </div>
